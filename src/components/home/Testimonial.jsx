    ...
    <div className="w-full bg-[#f3f4f6] text-customBlack">
      <div className="container mx-auto px-8 py-20">
        ...
        <div className="w-full lg:w-2/5 space-y-4 mb-10 lg:mb-16">
          <p className="w-fit py-1 px-3 font-medium bg-primary/10 rounded-full">
            Testimonial
          </p>
          ...
          {testimonials.map((t, index) => (
            <div key={index} className="p-6 bg-white rounded-2xl space-y-8">
              ...
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 grid place-items-center bg-primary/10 text-2xl text-[#374151] rounded-lg">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 25 24"
